...
export class VideoStudioSuite {
    ...
    bindTransformEvents() {
        ...
        const showTransformBox = () => {
            if (window.isDrawingRegion || (document.getElementById('videoOverlay')?.style.display === 'block')) {
                hideTransformBox(true);
                return;
            }
        ...
        const hideTransformBox = (force = false) => {
            if (this.transformBoxEl && (!isInteracting || force)) {
        ...
        this.showTransformBox = showTransformBox;
